...
import ShippingAddressScreen from './screens/client/ShippingAddressScreen';
...
import ProductEditScreen from './screens/client/ProductEditScreen';
import OrderListScreen from './screens/client/OrderListScreen';
import AboutUs from './screens/client/AboutUsScreen';
import HowToScreen from './screens/client/HowToScreen';
        ...
        <header>
          <Navbar className="navbar-custom" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand className="brand-name">Clothes</Navbar.Brand>
              </LinkContainer>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Nav className="ml-auto">
                  ...
                  {/* {userInfo ? (
                    ...
                    <NavDropdown title="1233sa"id="basic-nav-dropdown">
                      <LinkContainer to="/profile">
                        <NavDropdown.Item> User Profile </NavDropdown.Item>
                      </LinkContainer>
